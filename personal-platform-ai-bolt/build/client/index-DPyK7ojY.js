import { p as T } from "./single-fetch-DXQUw6pg.js";
import { P as M, N as $, c as E, D as j, e as N, T as S, I as G } from "./Header-DaHJSYVl.js";
class v {
  /**
  @internal
  */
...
const g = typeof T < "u" && T.env && /\bparse\b/.test(T.env.LOG);
let C = null;
function D(l, t, e) {
  ...
  advanceStack(t, e, s) {
    ...
    if (this.fragments) {
      ...
      for (let f = this.fragments.nodeAt(i); f; ) {
        ...
        if (p > -1 && f.length && (!a || (f.prop(N.contextHash) || 0) == u))
...
class tt {
  ...
  */
  constructor(t) {
    this.start = t.start, this.shift = t.shift || w, this.reduce = t.reduce || w, this.reuse = t.reuse || w, this.hash = t.hash || (() => 0), this.strict = t.strict !== !1;
  }
}
class y extends M {
  /**
  ...
  */
  configure(t) {
    let e = Object.assign(Object.create(y.prototype), this);
