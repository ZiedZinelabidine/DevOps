import { L as M, E as X, a as k, C as E } from "./index-DPyK7ojY.js";
import { s as A, t as i, y as C, L as I, A as l, m as f, E as J, a as B, B as D, F as K, i as N, f as H, g, d as F, G as OO, b as aO, H as T, k as QO, J as iO, I as eO } from "./Header-DaHJSYVl.js";
...
function u(O, a, Q) {
  ...
  for (; ; ) {
    let Z = a.firstChild, $;
    if (Z?.name == "VariableName")
      return r.push(O(Z)), { path: r.reverse(), name: Q };
    if (Z?.name == "MemberExpression" && ((e = $ = Z.lastChild) === null || e === void 0 ? void 0 : e.name) == "PropertyName")
      r.push(O($)), a = Z;
    else
      return null;
  }
...
const JO = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), BO = /* @__PURE__ */ C.inputHandler.of((O, a, Q, e, r) => {
  if ((JO ? O.composing : O.compositionStarted) || O.state.readOnly || a != Q || e != ">" && e != "/" || !o.isActiveAt(O.state, a, -1))
    return !1;
    ...
    if (P.name == "JSXStartTag" && (P = P.parent), !($.doc.sliceString(p - 1, p) != e || P.name == "JSXAttributeValue" && P.to > p)) {
      ...
      if (e == "/" && P.name == "JSXStartCloseTag") {
        ...
        if (x && S.from == p - 2 && ((h = Y($.doc, x.firstChild, p)) || ((s = x.firstChild) === null || s === void 0 ? void 0 : s.name) == "JSXFragmentTag")) {
          let j = `${h}>`;
          return { range: J.cursor(p + j.length, -1), changes: { from: p, insert: j } };
        }
      } else if (e == ">") {
        let S = IO(P);
