import { L as G, E as R, C as u } from "./index-DPyK7ojY.js";
import { s as w, t as $, L as v, a as V, f as g, i as U, b, g as q } from "./Header-DaHJSYVl.js";
import { defineCSSCompletionSource as E } from "./index-CMVEj-k-.js";
...
const nO = new R((O, e) => {
  ...
  if (O.peek(-1) == r) {
    ...
    for (; O.next != r && i.includes(O.next); )
      O.advance(), n++;
    n != a && O.next != r && !k(O) && (n < a ? O.acceptToken(X, -n) : O.acceptToken(z));
  }
}), RO = new R((O, e) => {
  for (let a = !1, Q = 0, n = 0; ; n++) {
    let { next: t } = O;
    if (d(t) || t == l || t == P || a && x(t))
      !a && (t != l || n > 0) && (a = !0), Q === n && t == l && Q++, O.advance();
    else if (t == m && O.peek(1) == j) {
      O.acceptToken(K, 2);
      break;
    } else {
      a && O.acceptToken(t == J ? I : Q == 2 && e.canShift(Z) ? Z : F);
      break;
    }
  }
}), lO = new R((O) => {
...
const SO = new Y(null, 0), cO = new u({
  ...
  tokenizers: [iO, oO, lO, dO, RO, nO, tO, rO, 0, 1, 2, 3],
...
function TO(O) {
  return new V(O?.indented ? kO : y, y.data.of({ autocomplete: fO }));
}
export {
  TO as sass,
