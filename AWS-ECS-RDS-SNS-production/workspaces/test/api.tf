module "api" {
  ...
  azure = {
    api_url          = "https://stg-erp.saveursetvie.fr/ecommerce/v1"
    certificate_path = "certs/ecommerce_client_certificate.p12"
  }

  aws_ses_domain_identity_arn      = module.aws_ses_domain_identity.arn
  dev_team_email                   = "saveursetvie.catch.preprod@thecodingmachine.com"
  send_commercial_service_email    = "service.commercial@test.saveursetvie.fr"
  receive_commercial_service_email = "test.service.commercial@saveursetvie.fr"
  send_web_order_email             = "commande.web@test.saveursetvie.fr"
  receive_web_order_email          = "test.commande.web@saveursetvie.fr"
