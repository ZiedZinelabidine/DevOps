...
resource "aws_iam_role_policy_attachment" "tcm_developpers_cognito" {
  role       = aws_iam_role.tcm_developpers.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonCognitoPowerUser"
}

resource "aws_iam_role_policy_attachment" "tcm_developpers_awstransfer" {
  role       = aws_iam_role.tcm_developpers.name
  policy_arn = "arn:aws:iam::aws:policy/AWSTransferFullAccess"
}

resource "aws_iam_role_policy_attachment" "tcm_developpers_awstransfer-console" {
  role       = aws_iam_role.tcm_developpers.name
