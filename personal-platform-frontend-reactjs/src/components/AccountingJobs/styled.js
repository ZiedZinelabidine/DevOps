...
export const ListingAccountingjobs = styled.div`
  background-color: white;
  width: 100%;
  min-height: 100vh;
  padding-left: 10px;
...
export const CardAccountingjobs = styled.div`
  margin-top: 60px;
  padding-left: 10px;
  padding-right: 10px;
`;
...
export const CardJob = styled.div`
  ...
  background-color: ${({ canApply, myJob }) =>
    canApply || myJob ? "#F8F8F8" : "transparent"};

  &:hover {
    color: black;
    border: none;
    background-color: #f8f8f8; // Keep hover background color
  }
`;
...
export const ViewLabelAccountingjobs = styled.div`
...
`;
export const ViewLabelMyAccountingjobs = styled.div`
  color: black;
  padding: 24px;
  font-family: Inter, sans-serif;
  height: 70px;
...
export const StyleAccountingjobsCount = styled.div`
  display: flex;
  font-family: Inter, sans-serif;
  padding-top: 24px;
  padding-left: 450px;
...
export const WarningMessage = styled.div`
  ...
  font-size: 16px;
  margin: 20px 0;
  font-weight: bold; /* You can adjust this and other styles as needed */
