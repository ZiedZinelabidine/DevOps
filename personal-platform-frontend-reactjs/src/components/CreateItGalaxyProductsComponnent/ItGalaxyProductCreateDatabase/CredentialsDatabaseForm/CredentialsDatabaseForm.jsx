...
const CredentialsDatabaseForm = ({
  ...
  return (
    <FormProvider {...formMethods}>
      <StyledLabel>
        3. Set up the credentials of your database , it will be used for
        connection{" "}
      </StyledLabel>{" "}
      <br />
      <StyleInputCred>
...
export default CredentialsDatabaseForm;
