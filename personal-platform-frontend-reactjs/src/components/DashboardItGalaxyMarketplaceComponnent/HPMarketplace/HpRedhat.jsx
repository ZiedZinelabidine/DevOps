...
import { Server, HardDrive, Check } from 'lucide-react';
...
const HeroIcon = styled(HardDrive)`
  width: 4rem;
  height: 4rem;
...
const plans = [
  {
    ...
    cpu: '1 vCPU',
    price: '$0.59',
    features: ['Redhat Linux 9 LTS', 'Basic Support', '99.9% Uptime'],
  },
  {
    name: 'Micro',
    storage: '8GB',
  ...
  },
  {
    ...
    cpu: '1 vCPU',
    price: '$0.79',
    features: ['Redhat Linux 9 LTS',  'Priority Support', '99.9% Uptime'],
    popular: true,
  },
  {
    name: 'Medium',
    ...
    cpu: '2 vCPU',
    price: '$0.89',
    features: ['Redhat Linux 9 LTS', '24/7 Premium Support', '99.99% Uptime'],
  },
];
  ...
  return (
    ...
    <Header />
      <HeroSection>
        <HeroContent>
          <HeroIcon />
          <HeroTitle>Solutions Serveur Redhat</HeroTitle>
          <HeroText>
              Serveurs Redhat hautes performances avec stockage fiable et support traduction exceptionnel
          </HeroText>
        </HeroContent>
      </HeroSection>
      ...
      <PricingSection>
        <PricingGrid>
          {plans.map((plan) => (
            <PlanCard key={plan.name} popular={plan.popular} onClick={handleModalRegister} >
              {plan.popular && (
