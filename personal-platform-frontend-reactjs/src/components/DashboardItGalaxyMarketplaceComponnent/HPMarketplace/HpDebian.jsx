...
const plans = [
  {
    ...
    cpu: '1 vCPU',
    price: '$0.59',
    features: ['Debian 12 LTS', 'Basic Support', '99.9% Uptime'],
  },
  {
    name: 'Micro',
    storage: '8GB',
  ...
  },
  {
    ...
    cpu: '1 vCPU',
    price: '$0.79',
    features: ['Debian 12 LTS',  'Priority Support', '99.9% Uptime'],
    popular: true,
  },
  {
    name: 'Medium',
    ...
    cpu: '2 vCPU',
    price: '$0.89',
    features: ['Debian 12 LTS', '24/7 Premium Support', '99.99% Uptime'],
  },
];
  ...
  return (
    ...
    <Header />
      <HeroSection>
        <HeroContent>
          <HeroIcon />
          <HeroTitle>Solutions Serveur Debian</HeroTitle>
          <HeroText>
              Serveurs Debian hautes performances avec stockage fiable et support traduction exceptionnel
          </HeroText>
        </HeroContent>
      </HeroSection>
