...
const plans = [
  {
    ...
    cpu: '1 vCPU',
    price: '$0.59',
    features: ['Postgres 17 LTS', 'Basic Support', '99.9% Uptime'],
  },
  {
    name: 'Micro',
    storage: '8GB',
  ...
  },
  {
    ...
    cpu: '1 vCPU',
    price: '$0.79',
    features: ['Postgres 17 LTS',  'Priority Support', '99.9% Uptime'],
    popular: true,
  },
  {
    name: 'Medium',
    ...
    cpu: '2 vCPU',
    price: '$0.89',
    features: ['Postgres 17 LTS', '24/7 Premium Support', '99.99% Uptime'],
  },
];
  ...
  return (
    ...
    <Header />
      <HeroSection>
        <HeroContent>
          <HeroIcon />
          <HeroTitle>Postgres Server Solutions</HeroTitle>
          <HeroText>
            High-performance Postgres servers with reliable storage and exceptional support
          </HeroText>
        </HeroContent>
      </HeroSection>
