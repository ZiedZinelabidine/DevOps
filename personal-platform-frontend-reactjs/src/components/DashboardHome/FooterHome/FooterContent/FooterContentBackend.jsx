    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "BACKEND Skills", items: BACKEND_SKILLS },
              { title: "BACKEND Projets", items: BACKEND_PROJECTS },
              { title: "Formations BACKEND", items: BACKEND_FORMATIONS },
              { title: "Blogs BACKEND", items: BACKEND_BLOGS },
              { title: "Questions communes par les BACKEND", items: BACKEND_Q1 },
              { title: "Questions communes par les BACKEND", items: BACKEND_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
...
export default FooterContentBackend;
