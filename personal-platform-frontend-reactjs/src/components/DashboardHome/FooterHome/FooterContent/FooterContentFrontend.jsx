...
function FooterContentFrontend() {
  const intl = useIntl();
    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "FRONTEND Skills", items: FRONTEND_SKILLS },
              { title: "FRONTEND Projets", items: FRONTEND_PROJECTS },
              { title: "Formations FRONTEND", items: FRONTEND_FORMATIONS },
              { title: "Blogs FRONTEND", items: FRONTEND_BLOGS },
              { title: "Questions communes par les FRONTEND", items: FRONTEND_Q1 },
              { title: "Questions communes par les FRONTEND", items: FRONTEND_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
...
export default FooterContentFrontend;
