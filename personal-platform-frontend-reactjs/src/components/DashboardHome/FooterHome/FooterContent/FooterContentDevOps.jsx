    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "DevOps Skills", items: DEVOPS_SKILLS },
              { title: "DevOps Projets", items: DEVOPS_PROJECTS },
              { title: "Formations DevOps", items: DEVOPS_FORMATIONS },
              { title: "Blogs DevOps", items: DEVOPS_BLOGS },
              { title: "Questions communes par les DevOps", items: DEVOPS_Q1 },
              { title: "Questions communes par les DevOps", items: DEVOPS_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
...
export default FooterContentDevOps;
