    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "MOBILE Skills", items: MOBILE_SKILLS },
              { title: "MOBILE Projets", items: MOBILE_PROJECTS },
              { title: "Formations MOBILE", items: MOBILE_FORMATIONS },
              { title: "Blogs MOBILE", items: MOBILE_BLOGS },
              { title: "Questions communes par les MOBILE", items: MOBILE_Q1 },
              { title: "Questions communes par les MOBILE", items: MOBILE_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
