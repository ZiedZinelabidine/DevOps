    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "WORDPRESS Skills", items: WORDPRESS_SKILLS },
              { title: "WORDPRESS Projets", items: WORDPRESS_PROJECTS },
              { title: "Formations WORDPRESS", items: WORDPRESS_FORMATIONS },
              { title: "Blogs WORDPRESS", items: WORDPRESS_BLOGS },
              { title: "Questions communes par les WORDPRESS", items: WORDPRESS_Q1 },
              { title: "Questions communes par les WORDPRESS", items: WORDPRESS_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
...
export default FooterContentWP;
