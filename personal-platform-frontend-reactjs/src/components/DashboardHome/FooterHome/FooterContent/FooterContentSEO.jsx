    ...
    <RootStyle>
      ...
      <StackStyle spacing={6} width={"100%"} style={{ padding: isTablet ? "5% 2%" : "5%" }}>
        <StackStyle spacing={4}>
          ...
          >
            {[
              { title: "SEO Skills", items: SEO_SKILLS },
              { title: "SEO Projets", items: SEO_PROJECTS },
              { title: "Formations SEO", items: SEO_FORMATIONS },
              { title: "Blogs SEO", items: SEO_BLOGS },
              { title: "Questions communes par les SEO", items: SEO_Q1 },
              { title: "Questions communes par les SEO", items: SEO_Q2 }
            ].map((section, index) => (
              <StackStyle
                key={index}
...
export default FooterContentSEO;
