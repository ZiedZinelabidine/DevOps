...
const Contact = () => {
  ...
  const TEXTS = {
    header: {
      title: "Besoin d'une formation Git avancée ?",
      subtitle: "Envie de maîtriser le contrôle de version, la collaboration en équipe, et l’automatisation des workflows avec Git et GitHub.",
