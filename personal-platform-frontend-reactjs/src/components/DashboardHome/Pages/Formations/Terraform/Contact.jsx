...
const Contact = () => {
  ...
  const TEXTS = {
    header: {
      title: "Vous cherchez une formation Terraform avancée ?",
      subtitle: "Développez vos compétences en gestion d'infrastructure as code, orchestration, automatisation de déploiement et optimisation cloud avec Terraform.",
