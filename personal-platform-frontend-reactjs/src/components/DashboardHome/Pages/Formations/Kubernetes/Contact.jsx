...
const Contact = () => {
  ...
  const TEXTS = {
    header: {
      title: "Besoin d'une formation Kubernetes avancée ?",
      subtitle: "Envie de maîtriser l'orchestration de containers, la gestion de clusters, la CI/CD, et la sécurité sur Kubernetes.",
