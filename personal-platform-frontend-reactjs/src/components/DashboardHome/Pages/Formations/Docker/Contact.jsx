...
const Contact = () => {
  ...
  const TEXTS = {
    header: {
        title: "Vous cherchez une formation Docker avancée ?",
        subtitle: "Développez vos compétences sur Docker, Kubernetes, déploiement automatisé et gestion des conteneurs.",
