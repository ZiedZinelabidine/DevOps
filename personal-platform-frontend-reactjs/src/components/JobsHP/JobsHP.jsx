...
import { formConfig } from "./JobsHP.constants";
...
const handleCloseModalRegister = () => {
  ...
  const handleItemClick = (item) => {
    if (!location.pathname.startsWith('/freelance-jobs') ) {
    setSelectedItem(item);
    setShowModalApply(true);
    } else {
      const url = `/shareJob?type=${item.type}&token=${item.display}`;
  ...
  return (
    <>
     {(location.pathname.startsWith('/freelance-jobs'))  && (
             <> 
            <Header active={"FREELANCERS"} />
            <Helmet>
              <title>Trouver des freelance jobs ou des missions freelances courtes</title>
              <meta
                  name="description"
                  content="Découvrez comment trouver des freelance jobs adaptés à vos compétences et vos ambitions. Rejoignez notre plateforme pour des opportunités passionnantes." // Provide a clear description here
              />
              <meta
                  name="keywords"
                  content="freelance jobs, travailler en freelance, offres d'emploi freelance, développeur freelance, freelance marketing" // Use relevant keywords here
              />
              <link rel="canonical" href="https://itgalaxy.io/freelance-jobs" />
              <meta property="og:title" content="Trouver un freelance développeur web ou une Agence de Développement web" />
              <meta
                  property="og:description"
                  content="Explorez des centaines d'offres de freelance jobs dans le développement web, le marketing et bien plus sur ItGalaxy." // Add relevant content for social sharing
              />
              <meta property="og:type" content="website" />
              <meta property="og:url" content="https://itgalaxy.io/freelance-jobs" />
              <meta property="og:locale" content="fr_FR" />
              <meta property="og:site_name" content="ItGalaxy.io" />
              <link rel="alternate" hreflang="fr" href="https://itgalaxy.io/freelance-jobs" />
              <link rel="alternate" hreflang="en" href="https://itgalaxy.io/freelance-jobs" />
          </Helmet>
              </>
          )}
      ...
      {!addNewJob ? (
        <Wrapper>
          <ContainerWrapper>
            <ListingJobs>
            <HeroTitle>Trouver des freelance jobs , des missions freelances courtes et des contrats Freelances</HeroTitle>
              <SearchBar>
                ...
                {((role === 'ENTREPRISE' || role === 'RECRUTER') && !location.pathname.startsWith('/freelance-jobs') ) && (
