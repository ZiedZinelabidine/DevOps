...
import { formConfig } from "./NewItGalaxyAService.constants";
...
import {
  ...
  SuccessText,
  SuccessIcon
} from "./NewItGalaxyAService.style";
...
export default function NewItGalaxyAService({ id, setNewItgalaxyAService }) {
    ...
    {submitted ? (
      ...
      <FormProvider {...methods} style={{ marginRight: "10px;" }}>
        <TitleStyle>
          ...
          <TitleForm>
            App As Service :  We take care of everything.
