...
export const StyledAboutMeCard = styled.div`
  width: 100%;
  display: ${({ isFullScreenExp }) => (isFullScreenExp ? "none" : "flex")};
...
export const StyledViewEntrepriseProfil = styled.div`
  width: 99%;
  display: flex;
  height: 98%;
  padding-top: 1%;
...
export const StyledReviewNumber = styled.p`
  display: flex;
  align-items: center; /* center align rating */
...
export const CommentUser = styled.span`
  font-weight: bold; /* makes username stand out */
  font-size: 16px; /* slightly larger font */
  color: #333; /* dark grey color */
`;

export const TextComment = styled.p`
  color: #555; /* medium grey text color for the comment */
  font-size: 14px; /* smaller font size for the comment */
...
export const StyledCommentsContainer = styled.div`
  ...
  min-height: 70vh;
  overflow-y: hide; // Allow vertical scrolling
